    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-3 md:px-5 md:py-4">
      <div className="flex flex-col gap-4">
        ...
        <p className="text-[#666666] text-[18px] max-w-2xl font-[320] leading-relaxed">
          Manage your workspace identity, team access, and resource allocation.
        </p>
      </div>

      <Tabs defaultValue={tab} className="w-full">
        <TabsList className="inline-flex h-11 items-center justify-center rounded-full bg-[#f1f1f1]/80 backdrop-blur-sm p-1 mb-10 border border-[#e6e6e6]/60">
          <TabsTrigger value="general" className="rounded-full px-10 text-[13px] font-[480] text-[#666666] transition-all duration-300 data-[state=active]:bg-white data-[state=active]:text-black data-[state=active]:shadow-[0_2px_10px_rgba(0,0,0,0.08)] data-[state=active]:px-10">General</TabsTrigger>
          <TabsTrigger value="team" className="rounded-full px-10 text-[13px] font-[480] text-[#666666] transition-all duration-300 data-[state=active]:bg-white data-[state=active]:text-black data-[state=active]:shadow-[0_2px_10px_rgba(0,0,0,0.08)] data-[state=active]:px-10">Team</TabsTrigger>
          <TabsTrigger value="billing" className="rounded-full px-10 text-[13px] font-[480] text-[#666666] transition-all duration-300 data-[state=active]:bg-white data-[state=active]:text-black data-[state=active]:shadow-[0_2px_10px_rgba(0,0,0,0.08)] data-[state=active]:px-10">Billing</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="general" className="space-y-8 animate-in fade-in duration-500">
          ...
          <div className="p-8 space-y-8 max-w-2xl">
            <div className="space-y-2.5">
              <Label className="font-mono text-[11px] uppercase tracking-[0.1em] text-[#999999]">Workspace Name</Label>
              <Input placeholder="Enter workspace name" className="h-11 bg-[#f7f7f5] border-transparent rounded-[12px] px-4 text-[14px] font-[450] focus:bg-white transition-all" />
            </div>
            <div className="space-y-2.5">
              <Label className="font-mono text-[11px] uppercase tracking-[0.1em] text-[#999999]">Workspace ID</Label>
              <div className="flex gap-2">
