  ...
  "inline-flex items-center justify-center gap-1.5 whitespace-nowrap rounded-md text-[13px] font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-brand text-primary-foreground shadow-[0_0_30px_-5px_oklch(0.62_0.22_280/0.6)] hover:shadow-[0_0_40px_-5px_oklch(0.62_0.22_280/0.8)] hover:scale-[1.02] transition-all",
        outlineGlow: "border border-primary/40 bg-primary/5 text-foreground hover:bg-primary/10 hover:border-primary/60 transition-all",
      },
      size: {
